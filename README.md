...
This is the repository of my AI Master's thesis work titled **"Low-Cost Imitation Learning for Dual-Arm Robots: Leveraging a Single Human Demonstration"** carried out at the [University of Groningen](https://www.rug.nl/masters/artificial-intelligence/?lang=en) under the supervision of [Prof. Dr. Hamidreza Kasaei](https://hkasaei.github.io/) and Georgios Tziafas ([IRL-Lab](https://www.ai.rug.nl/irl-lab/index.html)).
